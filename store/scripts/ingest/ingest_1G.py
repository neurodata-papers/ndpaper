...
def main():
  ...
  dataset_name='EM10K'        #(type=str, help='Name of Dataset')
  imagesize=(9472,7664,36)           #(type=int[], help='Image size (X,Y,Z)')
  voxelres=(1.0,1.0,1.0)            #(type=float[], help='Voxel scale (X,Y,Z)')

  channel_name='ch1'        #(type=str, help='Name of Channel. Has to be unique in the same project. User Defined.')
  ...
  project_name='EM10K'        #(type=str, help='Name of Project. Has to be unique in OCP. User Defined')
  token_name='EM10K'          #(type=str, default='', help='Token Name. User Defined')
