...
def main():
  ...
  dataset_name='chen15'        #(type=str, help='Name of Dataset')
  imagesize=(3773,9549,150)           #(type=int[], help='Image size (X,Y,Z)')
  ...
  datatype='uint32'            #(type=str, help='Channel Datatype')
  ...
  project_name='chen15'        #(type=str, help='Name of Project. Has to be unique in OCP. User Defined')
  token_name='chen15'          #(type=str, default='', help='Token Name. User Defined')
