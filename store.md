...
* Run the benchmark script [here](https://github.com/neurodata/ndstore/tree/microns/benchmarks/ndstore_benchmarks.py). The script must be run on the instance installed with ndstore.
...
* Run the following script to run the benchmark code [here](https://github.com/neurodata/ndtilecache/blob/master/benchmarks/ndtilecache_benchmark.py). The script must be run on the instance installed with ndtilecache.
* The commands are discussed in the [README](https://github.com/neurodata/ndtilecache/blob/master/benchmarks/README.md)
...
* Run the scripts [here](https://github.com/neurodata/ndpaper/tree/master/store/scripts/ingest) for each benchmark value.
* Run the script [here](Ingest.r) in the Plots folder. This script will generate the ingest graph in the paper.
